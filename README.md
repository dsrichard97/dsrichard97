...
Greetings! I'm Richard, a passionate mathematician and data enthusiast adept at deriving valuable insights from complex data. My journey in data science is rooted in hands-on experience from internships and academic studies. I've honed my expertise in statistical programming and data visualization, using tools like Tableau, SQL, and Excel. Working in the healthcare industry has enriched my understanding of patient care, healthcare operations, and research. I uphold the highest standards in data practices, focusing on integrity and accuracy in my analysis. My motivation lies in converting raw data into actionable insights for informed decision-making. I'm dedicated to exploring the evolving field of data science, striving for excellence and aiming to motivate and aid others on similar paths. I actively share my insights on platforms like Medium and Kaggle, continually challenging myself and contributing my views. I have a Bachelor's degree in Applied Mathematics from California State University, Fullerton, and am currently advancing my skills in statistical methods, especially in algorithms and models relevant to data science. 
